...
export default function Additional_workload() {
  ...
  const DisplayData = async () => {
    if (
      ...
      additionalWorkloadInfo11.length === 0
    ) {
      await axios
  ...
  const AcceptHandler = async (consignorCodeAccept, stopId, tripId) => {
    // console.log('df')
    console.log("Additional_Workload/AcceptHandler", {
    ...
    axios
      ...
      .then((response) => {
        console.log(
          "Additional_Workload/AcceptHandler/Msg Accepted ",
          response.data,
          "",
          userId
        );
        ...
        console.log(
          "Additional_Workload/AcceptHandler/Data ",
          data.length + " ",
          consignorCodeAccept
        );
      })
  ...
  const RejectHandler = async (consignorCodeReject, stopId, tripId) => {
    ...
    axios
      ...
      .then((response) => {
        console.log(
          "Additional_Workload/RejectHandler/Msg Rejected ",
          response.data
        );
        dispatch(setNotificationCount(notificationCount - 1));
        const updatedData = data.filter(
